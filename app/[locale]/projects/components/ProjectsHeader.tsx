    ...
    <div className={styles.header}>
      ...
      <div className={styles.filtersRow}>
        <div className={styles.filterGroup}>
          <ToggleButton
            appearance={isArchived === undefined ? 'primary' : 'secondary'}
            checked={isArchived === undefined}
          ...
          <ToggleButton
            appearance={isArchived === false ? 'primary' : 'secondary'}
          ...
          <ToggleButton
            appearance={isArchived === true ? 'primary' : 'secondary'}
        ...
        <div className={styles.datePickerGroup}>
          ...
          <DatePicker
            ...
            onSelectDate={(date) =>
              onDateRangeChange(date || null, createdDateTo)
            }
          />
          <DatePicker
            className={styles.datePicker}
            ...
            value={createdDateTo}
            onSelectDate={(date) =>
              onDateRangeChange(createdDateFrom, date || null)
            }
          />
        </div>
